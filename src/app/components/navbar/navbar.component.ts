...
export class NavbarComponent implements OnInit {
  ...
  constructor(location: Location, private element: ElementRef, private router: Router, private auth: AuthService, private toastr: ToastrService
  ) {
  ...
  getTitle() {
    ...
    console.log(titlee);
    if (titlee === "dashboard") {
      return " Compteur du nombre de passage au resto"
    }
  ...
  showNotification(from, align, num) {
    ...
    switch (color) {
      ...
      case 2:
        ...
        break;
      case 3:
        this.toastr.warning('<span class="now-ui-icons ui-1_bell-53"></span> <b>Notification</b> - Bye Bye, à la prochaine fois.', '', {
          timeOut: 3000,
          closeButton: true,
          enableHtml: true,
